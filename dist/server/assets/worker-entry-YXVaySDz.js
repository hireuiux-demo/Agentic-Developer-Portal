...
function getDefaultExportFromCjs(x3) {
  return x3 &&
    x3.__esModule &&
    Object.prototype.hasOwnProperty.call(x3, "default")
    ? x3["default"]
    : x3;
}
var react = { exports: {} };
...
function requireReact_production() {
  ...
  react_production.cloneElement = function (element, config2, children) {
    ...
    var props = assign({}, element.props),
      key = element.key;
    if (null != config2)
      for (propName in (void 0 !== config2.key && (key = "" + config2.key),
      config2))
...
const nullReplaceEqualDeep = (prev, next) =>
...
function getStylesheetHref(asset) {
  ...
  if (!(typeof rel === "string" ? rel.split(/\s+/) : []).includes("stylesheet"))
    return void 0;
  return href;
}
...
var re = () => {
  ...
  Rr = () => {
    let e = [],
      ...
      i = (l, g, S, d) => {
        for (g = 0, S = e.length; g < S; g++)
          ((d = e[g]),
            !t && g === S - 1 ? l[n2 ? "return" : "throw"](d) : l.next(d));
      },
      u = (l, g) => (
        t && ((g = a++), (r[g] = l)),
        i(l),
    ...
    return {
      ...
      throw: (l) => {
        t &&
          (e.push(l), s(l, "throw"), (t = false), (n2 = false), (r.length = 0));
      },
      return: (l) => {
        t &&
          (e.push(l), s(l, "return"), (t = false), (n2 = true), (r.length = 0));
      },
    };
  },
  vt = Rr.toString(),
...
function er(e) {
  ...
  return r.type === 1
    ? r.value
    : c(27, r.value, o, o, o, o, o, o, I(e, C), o, o, o);
}
function rr(e) {
  let r = Qe(e, Pt);
  return r.type === 1
    ? r.value
    : c(29, r.value, o, o, o, o, o, [k(e, 1), I(e, v)], o, o, o, o);
}
...
async function Rn(e, r, t) {
  ...
  for (let a = 0, s = t.length; a < s; a++)
    a in t ? (n2[a] = await N(e, r, t[a])) : (n2[a] = 0);
  return n2;
}
...
async function kr(e, r, t) {
  let n2 = Object.entries(t),
    a = [],
    s = [];
  for (let i = 0, u = n2.length; i < u; i++)
    (a.push(y(n2[i][0])), s.push(await N(e, r, n2[i][1])));
  return (
    C in t &&
      (a.push(I(e.base, C)), s.push(Ue(er(e.base), await N(e, r, $e(t))))),
    v in t &&
      (a.push(I(e.base, v)), s.push(je(rr(e.base), await N(e, r, Xe(t))))),
...
async function zn(e, r, t, n2) {
  let a = [],
    s = [];
  for (let [i, u] of n2.entries())
    (a.push(await N(e, r, i)), s.push(await N(e, r, u)));
...
function jt(e, r, t, n2) {
  let a = t.k;
  if (a.length > 0)
    for (let i = 0, u = t.v, l = a.length; i < l; i++) Zn(e, r, n2, a[i], u[i]);
  return n2;
}
function $n(e, r, t) {
...
function lo(e, r, t) {
  ...
  if (n2) {
    ...
    for (let s = 0, i = n2.length; s < i; s++) {
      let u = n2[s];
      if (u.tag === a)
        return b(e, t.i, u.deserialize(t.s, new Dr(e, r), { id: t.i }));
    }
  }
  throw new Q(t.c);
}
...
function ga(e, r) {
  ...
  if (n2 > 0) {
    e.base.stack.push(a);
    let s = rn(e, a, 0, t[0]);
    for (let i = 1, u = s; i < n2; i++)
      ((u = rn(e, a, i, t[i])), (s += (u && s && ",") + u));
...
function Jr(e, r, t) {
  let n2 = Object.entries(t),
    ...
    s = [];
  for (let i = 0, u = n2.length; i < u; i++)
    (a.push(y(n2[i][0])), s.push(E(e, r, n2[i][1])));
  return (
    C in t && (a.push(I(e.base, C)), s.push(Ue(er(e.base), E(e, r, $e(t))))),
    v in t &&
      (a.push(I(e.base, v)),
      s.push(je(rr(e.base), E(e, r, e.type === 1 ? te() : Xe(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push(X(t[P$1]))),
    R in t && (a.push(I(e.base, R)), s.push(t[R] ? J : Z)),
    { k: a, v: s }
  );
...
function Ta(e, r, t) {
  if (this.state.alive) {
    let n2 = G(this, r, t);
    (n2 && ie(this, c(23, e, o, o, o, o, o, [k(this.base, 2), n2], o, o, o, o)),
      be(this));
  }
}
function wa(e, r, t) {
...
function ha(e, r, t, n2) {
  let a = hr(e.base, {});
  return (
    e.type === 2 && (Xr(e), n2.then(Ta.bind(e, a, r), wa.bind(e, a, r))),
    ht(e.base, t, a)
  );
}
function za(e, r, t, n2, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.sync && u.test(n2))
      return fe(t, u.tag, u.parse.sync(n2, new Gr(e, r), { id: t }));
  }
  return o;
}
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated()
    ? /* @__PURE__ */ jsxRuntimeExports.jsx(React2.Fragment, { children })
    : /* @__PURE__ */ jsxRuntimeExports.jsx(React2.Fragment, {
        children: fallback,
      });
}
...
function requireReactDom_production() {
  ...
  var ReactSharedInternals =
    React3.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
var MatchInner = reactExports.memo(function MatchInnerImpl({ matchId }) {
  ...
  const getMatchPromise = (match2, key2) => {
    return (
      router.getMatch(match2.id)?._nonReactive[key2] ??
      match2._nonReactive[key2]
    );
  };
  {
    const match2 = router.stores.matchStores.get(matchId)?.get();
    ...
    if (match2._displayPending)
      throw getMatchPromise(match2, "displayPendingPromise");
    if (match2._forcePending)
      throw getMatchPromise(match2, "minPendingPromise");
...
performance.now();setTimeout(w,2300>q&&2E3<q?2300-q:500)})])},types:[]});z.ready.finally(function(){for(var a=l.length-3;0<=a;a-=3){var b=l[a],e=b.style;e.viewTransitionName=l[a+1];e.viewTransitionClass=l[a+1];""===b.getAttribute("style")&&b.removeAttribute("style")}});z.finished.finally(function(){document.__reactViewTransition===z&&(document.__reactViewTransition=null)});$RB=[];return}}catch(a){}A(g)}.bind(null,$RV);`,
  ...
  function is(x3, y2) {
    return (
      (x3 === y2 && (0 !== x3 || 1 / x3 === 1 / y2)) || (x3 !== x3 && y2 !== y2)
    );
  }
  ...
  function renderChildrenArray(request, task, children, childIndex) {
    ...
    if (
      null !== task.replay &&
      ((j2 = task.replay.slots), null !== j2 && "object" === typeof j2)
    ) {
...
const ReactDOMServer =
  /* @__PURE__ */ getDefaultExportFromCjs(server_edgeExports);
...
function getInlineCssAssetForMatches(manifest2, matches) {
  ...
  const css = getInlineCssForHrefs(
    manifest2,
    getInlineCssHrefsForMatches(manifest2, matches),
  );
...
function stripInlinedStylesheetAssets(manifest2, routes, matches) {
  ...
  for (const [routeId, route] of Object.entries(routes)) {
    const assets = route.assets?.filter(
      (asset) => !isInlinableStylesheet(manifest2, asset),
    );
    ...
    if (str.charCodeAt(i) === 62) {
      ...
      if (tagNameStart < i) {
        ...
        if (
          ...
          if (
            j2 >= 1 &&
            str.charCodeAt(j2) === 47 &&
            str.charCodeAt(j2 - 1) === 60
          )
            return i + 1;
        }
      }
...
function transformStreamWithRouter(router, appStream, opts) {
  ...
  function safeEnqueue(chunk) {
    ...
    if (typeof chunk === "string")
      controller.enqueue(textEncoder$1.encode(chunk));
...
const kEventResErrHeaders = /* @__PURE__ */ Symbol.for(
...
function toResponse(val, event, config2 = {}) {
  if (typeof val?.then === "function")
    return (val.catch?.((error) => error) || Promise.resolve(val)).then(
      (resolvedVal) => toResponse(resolvedVal, event, config2),
    );
  const response = prepareResponse(val, event, config2);
  if (typeof response?.then === "function")
    return toResponse(response, event, config2);
  ...
  if (val && val instanceof Error) {
    ...
    return onError && !nested
      ? Promise.resolve(onError(error, event))
          .catch((error2) => error2)
          .then((newVal) =>
            prepareResponse(newVal ?? val, event, config2, true),
          )
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } =
    await import("./_tanstack-start-manifest_v-CWF-fHJA.js");
...
if (!globalObj[GLOBAL_STORAGE_KEY])
  globalObj[GLOBAL_STORAGE_KEY] = new AsyncLocalStorage$1();
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CuSwdHdt.js").then((n2) => n2.b),
